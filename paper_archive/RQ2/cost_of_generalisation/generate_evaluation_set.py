...
parser.add_argument("--set", type=str, default="test", help="Where to store")
...
file_offset = 0
buffer = torch.zeros(min(args.num_samples, SHARD_SIZE), 11, dtype=torch.float32)
buffer_offset = 0

desc = f"Eval set file {file_idx} with morph offset {morph_offset} for {dof} DoF robots"
